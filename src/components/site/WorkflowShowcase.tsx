import { ArrowUpRight, Workflow, Mail, Bot, Tag } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {projects.map((p, i) => {
            ...
            return (
              <article
                key={p.title}
                className="group relative rounded-3xl border border-border bg-card overflow-hidden shadow-card hover:shadow-elevated transition-all duration-500 hover:-translate-y-1"
              >
                {/* Image area with dark frame */}
